<?php
/**
 * GeminiImageService (Q4 2026 Refactor — DELEGATE WRAPPER)
 *
...
class GeminiImageService extends GeminiService {
 ...
 public function extractMenuFromImage() { return $this->delegate->extractMenuFromImage(...func_get_args()); }
